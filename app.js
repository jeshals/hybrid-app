...
//    template.content.querySelector('img').src = file.path;
    template.content.querySelector('img').src = 'input/blank.png';
...
function displayPhotoInFullView (photo) {
    ...
    document.querySelector('#fullPhoto').src = filePath;
    document.querySelector('#fullPhoto').setAttribute('data-name', fileName);
    document.querySelector('#gridViewPhotos').style.display = 'none';
...
function backToGridView () {
    ...
    if (canvas) {
        ...
        image.setAttribute('id','fullPhoto');
    ...
    document.querySelector('#gridViewPhotos').style.display = 'block';
}
